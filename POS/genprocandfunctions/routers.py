class genprocandfunctionsRouter(object):
    """
    ...
    def db_for_read(self, model, **hints):
        ...
        if model._meta.app_label == 'genprocandfunctions':
            return 'form2_db'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == 'genprocandfunctions' and obj2._meta.app_label == 'genprocandfunctions' :
            return True
        # No opinion if neither object is in the Example app (defer to default or other routers).
        elif 'genprocandfunctions' not in [obj1._meta.app_label, obj2._meta.app_label]:
            return None
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        if app_label == 'genprocandfunctions':
